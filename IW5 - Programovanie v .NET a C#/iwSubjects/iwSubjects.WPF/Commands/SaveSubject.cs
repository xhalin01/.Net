...
{
    public class SaveSubject : ICommand
    {
        private readonly SubjectRepository _subjectRepository;
        private readonly SubjectDetailViewModel _viewModel;
        private readonly IMessenger _messenger;

        public SaveSubject(SubjectRepository repository, SubjectDetailViewModel viewModel, IMessenger messenger)
        {
        ...
        public void Execute(object parameter)
        {
            ...
            {
                _subjectRepository.Update(detail);
            }
            else
            {
                _viewModel.Detail = _subjectRepository.Insert(detail);
            }
